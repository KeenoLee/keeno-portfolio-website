        ...
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            <a href={sourceCode} target="_blank">
              <button
                type="submit"
                className="group flex items-center justify-center gap-2 h-[2rem] w-[8rem] bg-blue-600 text-white rounded-full outline-none transition-all focus:scale-110 hover:scale-110 hover:bg-blue-650 active:scale-105 dark:bg-white dark:bg-opacity-10 disabled:scale-100 disabled:bg-opacity-65"
              >
                Source Code
              </button>
            </a>
